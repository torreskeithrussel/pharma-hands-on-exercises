...
```{r}
adlb_plot <- function(adlb_FilePath, xlbl, ylbl) {
  
  ALT <- import(adlb_FilePath) %>% 
    filter(PARAMCD == "ALT")
...
adlb_plot("https://github.com/phuse-org/phuse-scripts/raw/master/data/adam/cdisc/adlbc.xpt", "Alanine Aminotransferase U/L", "Week")
