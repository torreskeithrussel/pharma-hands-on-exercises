...
mpg_filter(manufacturer == "jeep", year == 2008)
```
...
FilePath <- "https://github.com/phuse-org/phuse-scripts/raw/master/data/adam/cdisc/adlbc.xpt"
adlb <- import(FilePath)

adlb_plot <- function(data, x_var, y_var, ...) {
...
adlb_plot(adlb, LBSTRESN, WEEK, c(2, 4, 6, 8, 16, 24, 26))
